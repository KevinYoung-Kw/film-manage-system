-- 删除重复的create_order函数
-- 修复错误: Could not choose the best candidate function between multiple create_order functions

-- 删除所有版本的create_order函数，不管参数类型如何
...
-- 修复create_order函数，解决"record "v_showtime" has no field "price""错误
